...
public interface UserService {
     ...
     * 创建家长学生关系
     */
    com.campus.domain.entity.family.ParentStudentRelation createParentStudentRelation(com.campus.domain.entity.family.ParentStudentRelation relation);

    /**
     * 更新家长学生关系
     */
    com.campus.domain.entity.family.ParentStudentRelation updateParentStudentRelation(com.campus.domain.entity.family.ParentStudentRelation relation);
     ...
     * 分页查找家长学生关系
     */
    Page<com.campus.domain.entity.family.ParentStudentRelation> findParentStudentRelations(Pageable pageable, Long parentId, Long studentId, String relationType);

    /**
     * 根据关系类型获取关系列表
     */
    List<com.campus.domain.entity.family.ParentStudentRelation> getRelationsByType(String relationType);
     ...
     * 验证家长学生关系数据
     */
    Map<String, Object> validateParentStudentRelation(com.campus.domain.entity.family.ParentStudentRelation relation);

    /**
     * 批量创建家长学生关系
     */
    Map<String, Object> batchCreateParentStudentRelations(List<com.campus.domain.entity.family.ParentStudentRelation> relations);
     ...
     * 导入家长学生关系
     */
    Map<String, Object> importParentStudentRelations(List<com.campus.domain.entity.family.ParentStudentRelation> relations);

    /**
     * 导出家长学生关系
     */
    List<com.campus.domain.entity.family.ParentStudentRelation> exportParentStudentRelations(Long parentId, Long studentId, String relationType);
