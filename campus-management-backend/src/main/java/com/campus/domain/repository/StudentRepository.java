...
public interface StudentRepository extends JpaRepository<Student, Long> {
     ...
     * 分页查询所有未删除的学生
     */
    Page<Student> findByDeletedOrderByStudentNoAsc(Integer deleted, Pageable pageable);

    /**
     * 根据年级分页查询学生
     */
    Page<Student> findByGradeAndDeletedOrderByStudentNoAsc(String grade, Integer deleted, Pageable pageable);

    /**
     * 根据班级ID分页查询学生
     */
    Page<Student> findByClassIdAndDeletedOrderByStudentNoAsc(Long classId, Integer deleted, Pageable pageable);

    /**
     * 根据状态分页查询学生
     */
    Page<Student> findByStatusAndDeletedOrderByStudentNoAsc(Integer status, Integer deleted, Pageable pageable);
    ...
    @Query("""
        ...
        ORDER BY s.studentNo ASC
        """)
    Page<Student> findByStudentNoContainingOrNameContainingAndDeletedOrderByStudentNoAsc(
        @Param("keyword") String keyword, @Param("deleted") Integer deleted, Pageable pageable);

    /**
     * 分页查询所有未删除的学生（预加载关联数据）
     */
    @Query("""
        ...
        ORDER BY s.studentNo ASC
        """)
    Page<Student> findByDeletedWithAssociationsOrderByStudentNoAsc(@Param("deleted") Integer deleted, Pageable pageable);
    ...
    @Query("""
        ...
        ORDER BY s.studentNo ASC
        """)
    Page<Student> findBySearchWithAssociationsOrderByStudentNoAsc(
        @Param("keyword") String keyword, @Param("deleted") Integer deleted, Pageable pageable);
}
