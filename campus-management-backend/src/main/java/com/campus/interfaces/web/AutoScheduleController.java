...
public class AutoScheduleController {
    ...
    public String classrooms(
        ...
        List<com.campus.domain.entity.Classroom> classrooms = classroomRepository.searchClassrooms(
    ...
    public String timeSlots(
        ...
        List<com.campus.domain.entity.TimeSlot> timeSlots = timeSlotRepository.searchTimeSlots(
